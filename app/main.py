...
async def get_scores(
    ...
    """
    Get CFB game scores. If no parameters provided, returns current week's games.
    """
        ...
        try:
            ...
            for game in games:
                formatted_games.append({
                    ...
                    # Include raw game data for debugging
                    "raw": game if len(formatted_games) == 0 else None  # Only include first game's raw data
                })
